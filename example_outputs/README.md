...
This directory contains sample experiment outputs demonstrating the framework's capabilities.
...
```json
{
  "avg_success": 0.85,      // Average task success rate
  "avg_num_steps": 7.2,     // Average steps per task
